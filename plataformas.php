...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h1><i class="fa fa-fw fa-tag"></i> Plataformas</h1>
			<hr>
			<a href="./capPlataforma.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo</a>
      <a href="./menuAdmin.php" class="btn btn-danger">Salir</a>

					<?php
            $stmt = $conn->prepare("SELECT * FROM tblplataforma");
            $stmt->execute();
          ...
          ?>
    			...
    			<?php if(count($datos)>0):?>
              	...
              	<th>Transacción</th>
					...
					<tr>
						<td><?php echo $d['plataformaID'];?></td>
						<td><?php echo $d['plataforma'];?></td>
						<td class="text-center">
              <a href="./modificaPlataforma.php?id=<?php echo $d['plataformaID']?>" class="btn btn-default btn-xs"><i class="fa fa-pencil fa-fw"></i></a>
